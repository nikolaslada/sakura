...
$traversal_example = new Table($dibiConnection, $tableExample2, $columns, $alias = 't', $enabledTransaction = False);
$traversal = new TraversalTree($dibiConnection, $traversal_example, '');
